...
const TOOL_METADATA: ToolMetadata[] = [
  ...
  },
  {
    ...
    outputSchema: outputSchema({ templateId: { type: "string" }, version: { type: "number" }, status: { type: "string" }, renderer: { type: "string" }, rendererSource: { type: "string" } })
  },
  {
