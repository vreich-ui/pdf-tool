...
import { listPdfTemplatesResult } from "../lib/pdf-template-mcp.js";
...
export async function handler(event: FunctionEvent) {
  ...
  const result = await runWithStorageGrant(__grant.grant, () => listPdfTemplatesResult(parseInput(event) as never));
