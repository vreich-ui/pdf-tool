...
test("MCP JSON-RPC tools/list includes all artifact tools", async () => {
  ...
  assert.deepEqual(names, ["create_agent_artifact_job", "get_agent_artifact_by_filename", "get_agent_artifact_by_slot", "get_agent_artifact_job_status", "create_pdf_template", "get_pdf_template", "list_pdf_templates", "publish_pdf_template", "search_images", "get_image_search_job_status", "get_image_search_bank", "update_image_search_candidate", "get_image_search_policy", "set_image_search_policy", "import_image_from_url"].sort());
});
