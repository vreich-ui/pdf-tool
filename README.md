...
- `DR_LURIE_WORKFLOW_ENDPOINT`: optional future workflow endpoint for checked-out/locked workflow patching.
- `DR_LURIE_ENABLE_WORKFLOW_ATTACHMENT=1`: reserved switch for enabling adapter-mediated workflow attachment; default behavior is safe `workflowPatchStatus: "skipped"`.
